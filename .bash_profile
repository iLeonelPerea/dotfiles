...
export PATH=/usr/local/bin:/usr/local/sbin:$HOME/bin:/usr/local/git/bin:/usr/local/MacGPG2/bin:$HOME/Documents/repos/arcanist/arcanist/bin:$HOME/.composer/vendor/bin:$PATH
